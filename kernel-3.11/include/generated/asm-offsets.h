...
#define PV_CPU_usergs_sysret32 280 /* offsetof(struct pv_cpu_ops, usergs_sysret32)	# */
#define PV_CPU_usergs_sysret64 272 /* offsetof(struct pv_cpu_ops, usergs_sysret64)	# */
#define PV_CPU_swapgs 296 /* offsetof(struct pv_cpu_ops, swapgs)	# */
...
#define __NR_syscall_max 600 /* sizeof(syscalls_64) - 1	# */
#define NR_syscalls 601 /* sizeof(syscalls_64)	# */
#define __NR_ia32_syscall_max 350 /* sizeof(syscalls_ia32) - 1	# */
#define IA32_NR_syscalls 351 /* sizeof(syscalls_ia32)	# */
...
#define PARAVIRT_PATCH_pv_irq_ops 352 /* offsetof(struct paravirt_patch_template, pv_irq_ops)	# */
...
#define PV_CPU_iret 288 /* offsetof(struct pv_cpu_ops, iret)	# */
#define PV_CPU_irq_enable_sysexit 264 /* offsetof(struct pv_cpu_ops, irq_enable_sysexit)	# */
