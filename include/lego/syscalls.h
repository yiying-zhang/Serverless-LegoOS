...
asmlinkage long sys_remote_send_reply(const unsigned int dst_nid, const pid_t dst_pid, const void * msg, unsigned long msg_size, void * retbuf, unsigned long ret_size);
